...
class tariff285Test {
    ...
    private val tariff285 = SlotBasedTariff(
        id = TariffId(1),
    ...
    @Test
    fun `test tariff 285 with priceChart`() {
        val gson = Gson()
        val priceChart = gson.fromJson(
            FileReader("src/test/java/wtf/meier/tariff/interpreter/model/tariff/calculator/topTariffs/testData/Rate0285.json"),
